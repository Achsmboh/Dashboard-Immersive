...
const ModalTwo = ({ input1, input2, input3, input4, onClick }) => {
  return (
    <>
      ...
      <div className="modal modal-bottom sm:modal-middle">
        <form className="modal-box  flex flex-col justify-center items-center">
          ...
          <div className="grid grid-cols-2  max-w-md w-full mt-3">
            ...
            <button type="submit" onClick={onClick} className="btn bg-blue-600 normal-case font-Inter border-none mx-1 hover:bg-biruAltera">
